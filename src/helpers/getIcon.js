...
const getIcon = (code) => {
  switch (code) {
    ...
    case 802://scattered clouds
      return <img  loading="lazy" className="Icon" src={Cloudy2} alt={Cloudy2} />;

    case 803://broken clounds
      return <img  loading="lazy" className="Icon" src={Cloudy3} alt={Cloudy3} />;
    ...
    case 200://thunderstorm
      return <img  loading="lazy" className="Icon" src={Thunder} alt={Thunder} />;
