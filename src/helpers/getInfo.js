...
const getInfo = (code) => {
  switch (code) {
    ...
    case 501://moderate rain
      return  <p>A bit more rain,that sweather and an umbrella should do the trick </p>; 

    case 502://heavy intesity
      return  <p>The rains have come its time to get our gear right,Gumboots <span role="img" aria-label="Tick">✔️</span>,raincoat <span role="img" aria-label="Tick">✔️</span> and an ambrella <span role="img" aria-label="Tick">✔️</span></p>;
    case 503:// very heavy intesity
      return  <p>It seems noahs times are back the rain today is insane,lets build an ark or something</p>;

    case 600://ligth snow
      return  <p>Light snow lets dress warmly and go make a snow man outside <span role="img" aria-label="Snowman">&#9731;</span></p>;

    case 601://snow
      return  <p>its snowing outside lets stick indoors </p>;

    case 602://heavy snow
      return  <p>Now the snow seems to be getting personal but its okay lets start up that fireplace fire</p>;

    case 200://thunderstorm
      return  <p>Just got struck by lightning flying in this thunderstorm is unbearable,better keep indoors</p>;
    ...
    case 301://drizzle
      return <p>Rain, but not terminal. Wear a coat i dont want you to catch a coldor something</p>;;

    case 302: //heavy intesity drizzle
      return <p>Rain, of the annoying variety. Don't get caught out</p>;
 
    case 701://mist
      return <p>The air is thick with mist and there's just barely a light rain. Tread carefully</p>;

    case 711://smoke
      return <p>Smoke warning - potential forest fire hazard. Be extremely vigilant and on the lookout for the most up to date weather advisories</p>;

    case 721://haze
      return <p>The sun's out but it's hazy.Lazy days are made of this</p>;

    case 731://dust
      return <p>Like walking out in the Sahara is what it looks like out there.</p>;
    case 741://fog
      return<p>Foggy weather. Visibility severely impacted. Take extreme care when driving if you must.</p>;
    default:
      return <p></p>;
  }
};
